...
### Sensors
The sensors used are the ultrasonic sensor, the MQ-3 alcohol sensor and the push-button.
...
### Actuators
The actuators used in the system are the servo motor, three LEDs (mini traffic light), and a buzzer.
- #### Servo motor KY66:
